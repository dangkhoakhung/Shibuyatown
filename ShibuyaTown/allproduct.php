                                    ...
                                    <div class="col-lg-9 col-md-12">
                                        ...
                                        <!--shop toolbar end-->
                                           <div class="maincontent">
                                                ...
                                                ?>        
                                                    <li>
                                                        <a style="text-align:center;" href="single-product.php?quanly=sanpham&id=<?php echo $row['id_sanpham'] ?>">
                                                            <img src="admincp/modules/quanlysp/uploads/<?php echo $row['hinhanh'] ?>" >
                                                            <p class="price_product"><b><?php echo number_format($row['giasp'],0,',',',').'đ' ?></b></p>
